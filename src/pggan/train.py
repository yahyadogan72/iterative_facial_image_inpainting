...
#        G_lrate_base            = 0.0001,    # Learning rate for the generator.
...
#    resume_run_id           = 'results/001-pgan-celebahq-preset-v2-1gpu-fp32/network-snapshot-006608.pkl',         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_run_id           = None,
