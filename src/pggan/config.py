...
data_dir = 'C:/Users/user/Desktop/TIK3/PGGAN_128_test_celeba/datasets'
#data_dir = 'E:/celebahq_tfrecords'
result_dir = 'results'
...
#desc += '-celebahq';            dataset = EasyDict(tfrecord_dir='E:/celebahq_tfrecords'); train.mirror_augment = True
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16}; train.total_kimg = 12000
